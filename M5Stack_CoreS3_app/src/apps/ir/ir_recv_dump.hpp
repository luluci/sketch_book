...
namespace app
{
	...
	class ir_recv_dump : public base
	{
		...
		// caption label
		static constexpr char const *intr_dump_caption_ = "IR Recv data:";
		static constexpr char const *txrx_dump_caption_ = "dummy:";
		//
		static constexpr size_t intr_dump_size_ = 1024;
		char intr_dump_[intr_dump_size_];
		static constexpr size_t txrx_dump_size_ = 100;
